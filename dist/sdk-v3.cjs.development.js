...
var IAvadexPair = _interopDefault(require('@avadex-libs/avadex-swap-core/build/IAvadexPair.json'));
...
var FACTORY_ADDRESS = '0x422efc9fe9e33e46d1b33d432ea15b3b389454af';
var INIT_CODE_HASH = '0x900ec688aaed2eb0cc1f64b8ffbeaf4674e555db3be8889afd8c245ad2ba784e';
...
var WETH = (_WETH = {}, _WETH[exports.ChainId.MAINNET] = /*#__PURE__*/new Token(exports.ChainId.MAINNET, '0xB31f66AA3C1e785363F0875A1B74E27b85FD66c7', 18, 'WAVAX', 'Wrapped AVAX', 'https://www.avax.network/'), _WETH[exports.ChainId.BSCTESTNET] = /*#__PURE__*/new Token(exports.ChainId.BSCTESTNET, '0xaE8E19eFB41e7b96815649A6a60785e1fbA84C1e', 18, 'WBNB', 'Wrapped BNB', 'https://www.binance.org'), _WETH);
...
var Pair = /*#__PURE__*/function () {
  function Pair(tokenAmountA, tokenAmountB) {
    ...
    this.liquidityToken = new Token(tokenAmounts[0].token.chainId, Pair.getAddress(tokenAmounts[0].token, tokenAmounts[1].token), 18, 'AVEX-LP', 'Avadex LPs');
...
var ZERO_HEX = '0x0';
/**
 * Represents the Ava Dex Router, and has static methods for helping execute trades.
 */
...
var Fetcher = /*#__PURE__*/function () {
  ...
  Fetcher.fetchPairData = function fetchPairData(tokenA, tokenB, provider) {
    try {
      ...
      return Promise.resolve(new contracts.Contract(address, IAvadexPair.abi, provider).getReserves()).then(function (_ref) {
...
//# sourceMappingURL=sdk-v3.cjs.development.js.map
